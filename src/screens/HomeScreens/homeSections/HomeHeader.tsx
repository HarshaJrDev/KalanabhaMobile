...
const IS_COMPACT_WIDTH = Dimensions.get('window').width < 360;
...
const makeStyles = (COLORS: HomeColors, FONTS: HomeFonts) => StyleSheet.create({
    ...
    heroCopy: { flex: 1, paddingLeft: 18, paddingVertical: 18, paddingRight: 4, zIndex: 2 },
    dispatchCaptionRow: { flexDirection: 'row', alignItems: 'center', gap: 5, marginBottom: 8, flexWrap: 'wrap' },
    dispatchCaptionText: { color: COLORS.primaryDark, fontSize: 10, fontFamily: FONTS.BOLD_PRIMARY, letterSpacing: 0.4, textTransform: 'uppercase' },
    dispatchCaptionDot: { width: 3, height: 3, borderRadius: 1.5, backgroundColor: COLORS.primary },
    heroKicker: { color: COLORS.textSecondary, fontSize: 12, fontFamily: FONTS.MEDIUM_PRIMARY, marginBottom: 4 },
    heroTitle: { color: COLORS.textPrimary, fontSize: IS_COMPACT_WIDTH ? 22 : 25, lineHeight: IS_COMPACT_WIDTH ? 27 : 30, fontFamily: FONTS.BOLD_PRIMARY },
